    ...
    modules: [
      {
        name: 'Fundamentos de Ergonomía', stages: [
          { type: 'lectura', title: 'Principios ergonómicos', videoUrl: 'https://www.youtube.com/embed/Y0fF0Yh8Xas', content: '<h3>¿Qué es la ergonomía?</h3><p>Es la disciplina que se encarga de adaptar el trabajo a las capacidades y limitaciones del ser humano, buscando optimizar el bienestar y el rendimiento.</p><h3>Desórdenes musculoesqueléticos (DME)</h3><ul><li>Síndrome del túnel carpiano</li><li>Lumbalgia ocupacional</li><li>Tendinitis</li><li>Cervicalgia</li></ul><p>Los DME representan más del 60% de las enfermedades laborales en Colombia.</p><h3>Factores de riesgo ergonómico</h3><ul><li>Posturas prolongadas o forzadas</li><li>Movimientos repetitivos</li><li>Manipulación manual de cargas</li><li>Vibración y presión mecánica</li></ul>' },
